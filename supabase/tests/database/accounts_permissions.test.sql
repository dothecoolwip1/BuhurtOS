...
values
('10000000-0000-0000-0000-000000000051','10000000-0000-0000-0000-000000000004','Fighter A'),
('20000000-0000-0000-0000-000000000051','20000000-0000-0000-0000-000000000002','Fighter B');

insert into public.fighters(id,organization_id,team_id,user_id,identity_id,name,is_active)
values
('10000000-0000-0000-0000-000000000050','10000000-0000-0000-0000-000000000010','10000000-0000-0000-0000-000000000040','10000000-0000-0000-0000-000000000004','10000000-0000-0000-0000-000000000051','Fighter A',true),
('20000000-0000-0000-0000-000000000050','20000000-0000-0000-0000-000000000010','20000000-0000-0000-0000-000000000040','20000000-0000-0000-0000-000000000002','20000000-0000-0000-0000-000000000051','Fighter B',true);
...
select throws_ok(
  $sql$select public.assign_organization_role('10000000-0000-0000-0000-000000000010','10000000-0000-0000-0000-000000000001','organization_staff')$sql$,
  'P0001',
...
select lives_ok(
  $sql$select public.revoke_organization_role('10000000-0000-0000-0000-000000000010','10000000-0000-0000-0000-000000000005','organization_staff')$sql$,
  'organization administrator can revoke organization staff assigned to another account'
);

select lives_ok(
  $sql$select public.revoke_event_membership(id) from public.event_memberships where event_id='10000000-0000-0000-0000-000000000031' and user_id='10000000-0000-0000-0000-000000000005' and role='fighter'$sql$,
