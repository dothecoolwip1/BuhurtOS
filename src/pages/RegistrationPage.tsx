...
export function RegistrationPage() {
  ...
  const [form, setForm] = useState({ email: '', displayName: '', teamName: '', category: 'Duel', phone: '', emergencyContact: '', waiverAcknowledged: false });
